#!/bin/bash
echo "Deploying Splunk from a Docker Instance on Ubuntu Server 20 by Rafael Contin CW"
admin_password=CyberWarriorSplunk

apt-get update && sudo apt-get install apt-transport-https ca-certificates curl gnupg lsb-release -y
...
echo "      - SPLUNK_PASSWORD=$admin_password" >> docker-compose.yml
...
echo "The Splunk Web UI is at https://IP:8083"
